...
def main():
    parser = argparse.ArgumentParser(description='Compute hash of the file and rename it to hash')
    parser.add_argument('-f', metavar='--filepath', type=str, help='file to be hashed')
    parser.add_argument('-F', metavar='--folder', type=str, help='folder with files to be hashed')
    parser.add_argument('-a', metavar='--algorithm', type=str, help='hash algorithm')
